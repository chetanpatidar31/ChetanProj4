            ...
            <table style="width: 100%">
                <tr>
                    <td align="center">
                        ...
                        <%=HTMLUtility.getList("courseId", String.valueOf(bean.getId()), courseList)%>&emsp;&nbsp;
            ...
            <table style="width: 100%">
                <tr>
                    ...
                    <td style="width: 25%" align="right">
                        <input type="submit" name="operation" value="<%=CourseListCtl.OP_NEXT%>" <%=nextListSize != 0 ? "" : "disabled"%>>
                    </td>
                </tr>
            </table>
